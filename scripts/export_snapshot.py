        ...
        agents.append({
            **spec,
            ...
            "adaptation": adaptations.get(agent["id"], {
                ...
                "upper_bound": None, "allocation_multiplier": 0, "state": "research",
            }),
    ...
    output = {
        ...
        "summary": {
            ...
            "adaptation": {
                ...
                "research": sum(row.get("state") == "research" for row in adaptation_rows),
                ...
                "rejected": sum(row.get("state") == "rejected" for row in adaptation_rows),
                ...
                "counterfactual_recorded": sum(row.get("evaluation_class") == "eligible-shadow" for row in evaluation_rows),

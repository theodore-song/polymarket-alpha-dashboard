...
export default function Home() {
  ...
  const [epochs, setEpochs] = useState<Epoch[]>([{ id: 'v2-edge-only', label: 'V2.2 · Adaptive news-confirmed alpha', file: '/data/snapshot.json', current: true }]);
